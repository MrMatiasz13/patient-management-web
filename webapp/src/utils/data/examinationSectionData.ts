...
export const section3yo: ExaminationSectionProps = {
  title: "Niebieski - 3 lata",
  items: ["Pokaż Pociąg.", "Pokaż ucho misia."],
  color: "blue",
};

export const section4yo: ExaminationSectionProps = {
  title: "Zielony - 4 lata",
  items: ["Pokaż czym się je zupę.", "Pokaż pojemnik na sól."],
  color: "green",
};

export const section5yo: ExaminationSectionProps = {
...
export const section6yo: ExaminationSectionProps = {
